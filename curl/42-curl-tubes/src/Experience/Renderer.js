...
export default class Renderer {
  constructor() {
    ...
    this.sceneBg = this.experience.sceneBg;
  ...
  setDebug = () => {
    ...
    debugFolder
      .add(this.params, "toneMapping", Object.keys(this.toneMappingOptions))
      .onChange((val) => {
        ...
        if (this.params.toneMapping !== "None") {
          this.guiExposure = debugFolder
            .add(this.params, "exposure", 0, 2)
            .onChange((val) => {
  ...
  setInstance() {
    ...
    this.instance.toneMapping = this.toneMappingOptions.Linear;
    this.instance.toneMappingExposure = this.params.exposure;
  ...
  update() {
    this.instance.render(this.sceneBg, this.camera.instance);
